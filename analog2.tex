...
\subsection{b}
動画で使用したトランジスタ増幅回路の構成部品について、公称値および測定値を表\ref{tab:parts}に示す。
\begin{table}[H]
\centering
...
\[
V_{CEQ}=7.780~\mathrm{V},\qquad
I_{CQ}=1.83~\mathrm{mA}
\]
...
で表され，動作点を通るように$I_C$-$V_{CE}$特性上へ描いた。

直流負荷線および交流負荷線を描いた結果を図\ref{fig:loadline}に示す。
